...
@section('page-header')
    ...
    </span> Dashboard {{ Auth::user()->branches[0]->name }}
@endsection
    ...
    <div class="row">
        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-info card-img-holder text-white">
                <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">{{ \Carbon\Carbon::now()->format('F') }}'s Profits <i
                            class="mdi mdi-bookmark-outline mdi-24px float-end"></i>
                    </h4>
                    <h2 class="mb-5">Rp. {{ number_format($appointmentProfit) }}</h2>
                    <h6 class="card-text">+ 0%</h6>
                </div>
            </div>
        </div>
        @php
            ...
            $netProfit = $appointmentProfit - $suppliesExpenses;

            // Calculate the percentage profit
            $percentageProfit = 0;
            if ($suppliesExpenses > 0) {
                $percentageProfit = ($netProfit / $suppliesExpenses) * 100;
            }
        @endphp
        <div class="col-md-4 stretch-card grid-margin">
